<div class="mega-menu">
    ...
    <ul>
            ...
            <div class="projects-menu menu-content">
                ...
                <div class="tab-wrap" id="tab-content-1">
                    ...
                    <div class="project-content">
                        ...
                        <p><a href="{{route('projects.index')}}"><img loading="lazy" class="alignnone"
                    ...
                    <div class="project-content">
                        ...
                        <h3>Aviation</h3>
                        <p><a href="{{route('projects.eagle-county-regional-airport-expansion-remodel')}}"><img
                        ...
                        <h4><a href="{{route('projects.eagle-county-regional-airport-expansion-remodel')}}">Eagle
                    ...
                    <div class="project-content">
                        ...
                        <h3>Education</h3>
                        <p><a href="{{route('projects.bethune-cookman-university-residence-halls')}}"><img
                        ...
                        <h4><a href="{{route('projects.bethune-cookman-university-residence-halls')}}">Bethune-Cookman
                    ...
                    <div class="project-content">
                        ...
                        <p><a
                                href="{{route('projects.foreign-affairs-security-training-center-fastc-contracts-1-3')}}"><img
                        ...
                        <h5><span style="color: #ffffff;">Featured Government + Justice Case
                                Study</span></h5>
                        <h4><a
                                href="{{route('projects.foreign-affairs-security-training-center-fastc-contracts-1-3')}}">Foreign
                    ...
                    <div class="project-content">
                        ...
                        <h3>Healthcare</h3>
                        <p><a
                                href="{{route('projects.the-university-of-texas-medical-branch-at-galveston-jennie-sealy-replacement-hospital')}}"><img
                        ...
                        <h4><a
                                href="{{route('projects.the-university-of-texas-medical-branch-at-galveston-jennie-sealy-replacement-hospital')}}">The
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('projects.kalahari-resort-convention-center')}}">Kalahari Resort
                    ...
                    <div class="project-content">
                        ...
                        <p><a href="{{route('projects.wmata-andrews-federal-center-bus-garage')}}"><img
                        ...
                        <h5><span style="color: #ffffff;">Featured Infrastructure + Transportation
                                Case Study</span></h5>
                        <h4><a href="{{route('projects.wmata-andrews-federal-center-bus-garage')}}">WMATA
                    ...
                    <div class="project-content">
                        ...
                        <p><a href="{{route('industry.science-technology')}}" ><img loading="lazy"
                        ...
                        <h5><span style="color: #ffffff;">Featured Science + Technology Case
                                Study</span></h5>
                        <h4><a href="{{route('industry.science-technology')}}" >Science +
                                Technology</a></h4>
                    ...
                    <div class="project-content">
                        ...
                        <p><a
                                href="{{route('projects.kailua-regional-wastewater-treatment-plant-tunnel-influent-pump-station-headworks-facility')}}"><img
                                    loading="lazy" class="wp-image-2837 size-medium alignnone"
                        ...
                        <h5><span style="color: #ffffff;">Featured Water + Wastewater Case
                                Study</span></h5>
                        <h4><a
                                href="{{route('projects.kailua-regional-wastewater-treatment-plant-tunnel-influent-pump-station-headworks-facility')}}">Kailua
            ...
            <div class="projects-menu menu-content">
                ...
                <div class="tab-wrap" id="tab-content-2">
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('what-we-do.index')}}" >We develop, construct and maintain
                    ...
                    <div class="project-content">
                        ...
                        <p><img loading="lazy" class="wp-image-2524 size-medium alignnone"
                                ...
                                srcset="{{asset('wp-content/uploads/2017/07/development-300x200.jpg')}} 300w, {{asset('wp-content/uploads/2017/07/development.jpg')}} 600w"
                                sizes="(max-width: 300px) 100vw, 300px" /></p>
                        <h5><span style="color: #ffffff;">A Roadmap to Success</span></h5>
                        <h4><a href="{{route('what-we-do.development')}}" >Our development services
                    ...
                    <div class="project-content">
                        ...
                        <p><img loading="lazy" class="wp-image-2525 size-medium alignnone"
                                ...
                                alt="" width="300" height="200"
                                srcset="{{asset('wp-content/uploads/2017/07/construction-300x200.jpg')}} 300w, {{asset('wp-content/uploads/2017/07/construction.jpg')}} 600w"
                                sizes="(max-width: 300px) 100vw, 300px" /></p>
                        <h5><span style="color: #ffffff;">Building Landmark Properties</span></h5>
                        <h4><a href="{{route('what-we-do.construction')}}" >From preconstruction
                    ...
                    <div class="project-content">
                        ...
                        <p><img loading="lazy" class="alignright size-medium wp-image-7027"
                                ...
                                srcset="{{asset('wp-content/uploads/2018/10/Technician-in-Server-Room-300x225.jpg')}} 300w, {{asset('wp-content/uploads/2018/10/Technician-in-Server-Room-768x576.jpg')}} 768w, {{asset('wp-content/uploads/2018/10/Technician-in-Server-Room-1024x768.jpg')}} 1024w"
                                sizes="(max-width: 300px) 100vw, 300px" /></p>
                        <h5><span style="color: #ffffff;">Optimizing Operations</span></h5>
                        <h4><a href="{{route('what-we-do.facility-services')}}" >Even after
        ...
        <li>
            ...
            <a id="menu3" href="{{route('trade-partners')}}">Partners</a>
        </li>
                ...
                <div class="tab-wrap" id="tab-content-4">
                    ...
                    <div class="project-content">
                        ...
                        <h5><span style="color: #ffffff;">Delivering EXCELLENCE in all we
                                do.</span></h5>
                        <h4><a href="{{route('about.ourway')}}">The Alticor Inc core values:
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.ourway')}}">The Alticor Inc Way: People,
                    ...
                    <div class="project-content">
                        ...
                        <p><img loading="lazy" class="size-medium wp-image-2533 alignnone"
                                ...
                                alt="" width="300" height="200"
                                srcset="{{asset('wp-content/uploads/2017/07/safety-300x200.jpg')}} 300w, {{asset('wp-content/uploads/2017/07/safety.jpg')}} 600w"
                                sizes="(max-width: 300px) 100vw, 300px" /></p>
                        <h5><span style="color: #ffffff;">A Zero-Accident Safety Culture</span>
                        </h5>
                        <h4><a href="{{route('about.safety')}}">We maintain an unwavering commitment to
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.quality')}}">Alticor Inc uses a proven six-step
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.sustainability')}}">We help you make informed
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.technology')}}">We are constantly creating new
                    ...
                    <div class="project-content">
                        ...
                        <p><img loading="lazy" class="alignnone size-medium wp-image-2313"
                                ...
                                srcset="{{asset('wp-content/uploads/2017/06/hp_aboutus-300x167.jpg')}} 300w, {{asset('wp-content/uploads/2017/06/hp_aboutus-768x426.jpg')}} 768w, {{asset('wp-content/uploads/2017/06/hp_aboutus-1024x568.jpg')}} 1024w, {{asset('wp-content/uploads/2017/06/hp_aboutus.jpg')}} 1427w"
                                sizes="(max-width: 300px) 100vw, 300px" /></p>
                        <p>&nbsp;</p>
                        <h5><span style="color: #ffffff;">Celebrating 80 Years</span></h5>
                        <h4><a href="{{route('about.history')}}">From one man’s dream to one of America’s most
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.community')}}">Building Stronger Communities Together.</a>
                        </h4>
                    ...
                    <div class="project-content">
                        ...
                        <h3>News Center</h3>
                        <p><a href="{{route('about.news-center')}}"><img loading="lazy" class="alignnone"
                                    src="{{ asset('wp-content/uploads/2017/05/news-news.jpg') }}"
                                    alt="" width="300" height="200" /></a></p>
                        <h5><span style="color: #ffffff;">What’s Happening</span></h5>
                        <h4><a href="{{route('about.news-center')}}">Stay in the know with Alticor Inc news
                                and events.</a></h4>
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.leadership')}}">Project leadership is one of the
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.recognition-awards')}}">At Alticor Inc, our work speaks
                                for itself.</a></h4>
                    ...
                    <div class="project-content">
                        ...
                        <h4><a href="{{route('about.recognition-awards')}}">We welcome the opportunity to work
