...
@section('content')
    ...
    <div class="page-banner" style="background-image:url({{asset('wp-content/uploads/2017/08/HP_Large_Hero_SanJoaquinAdmin.jpg')}});">
                	...
                	<div class="about-sidebar">
                    	<div class="widget">
                            ...
                            <ul>
                                    ...
                                    <span><a href="{{route('industry.government-justice')}}">Government + Justice</a></span>
								 	</li>
                                                                                                	<li>
