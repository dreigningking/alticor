...
<!-- Mirrored from henselphelps.com/project/aegis-ashore-missile-defense-test-complex/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Feb 2023 18:10:44 GMT -->
...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<title>Aegis Ashore Missile Defense Test Complex - Alticor Inc</title>
	<meta name="description" content="Alticor Inc pursued the Aegis Ashore project as a &quot;Super Sub&quot; to URS Group, Inc., and developed the project estimate, technical proposal and schedule." />
	...
	<meta property="og:image" content="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web2.jpg')}}"  />
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content="Aegis Ashore Missile Defense Test Complex" />
	<meta name="twitter:description" content="Alticor Inc pursued the Aegis Ashore project as a &quot;Super Sub&quot; to URS Group, Inc., and developed the project estimate, technical proposal and schedule." />
	<meta name="twitter:image" content="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web2.jpg')}}"  />
	<meta name="twitter:site" content="@HenselPhelps" />
	<meta name="twitter:label1" content="Est. reading time" />
	<meta name="twitter:data1" content="1 minute" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/","url":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/","name":"Aegis Ashore Missile Defense Test Complex - Alticor Inc","isPartOf":{"@id":"https://publicwebsite.azurewebsites.net/#website"},"primaryImageOfPage":{"@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/#primaryimage"},"image":{"@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/#primaryimage"},"thumbnailUrl":"{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg')}}" ,"datePublished":"2019-06-20T17:51:12+00:00","dateModified":"2019-08-20T17:09:18+00:00","description":"Alticor Inc pursued the Aegis Ashore project as a \"Super Sub\" to URS Group, Inc., and developed the project estimate, technical proposal and schedule.","breadcrumb":{"@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["{{route('projects.aegis-ashore-missile-defense-test-complex')}}/"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/#primaryimage","url":"{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg')}}" ,"contentUrl":"{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg')}}" ,"width":1440,"height":720},{"@type":"BreadcrumbList","@id":"{{route('projects.aegis-ashore-missile-defense-test-complex')}}/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://publicwebsite.azurewebsites.net/"},{"@type":"ListItem","position":2,"name":"Aegis Ashore Missile Defense Test Complex"}]},{"@type":"WebSite","@id":"https://publicwebsite.azurewebsites.net/#website","url":"https://publicwebsite.azurewebsites.net/","name":"Alticor Inc","description":"","potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://publicwebsite.azurewebsites.net/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"}]}</script>
...
<body class="project-template-default single single-project postid-7925 do-etfw">
...
<style type="text/css">
 .page-banner{               
 filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg', sizingMethod='scale');
-ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg', sizingMethod='scale')"; 
 }
</style>        
<![endif]-->
    ...
    <div class="page-banner" style="background-image:url(
            ...
            '../../wp-content/uploads/2019/06/Aegis-Ashore-web-red.jpg'	
        ...
        <div class="page-banner-block">
            ...
            <div class="page-banner-content">
                ...
                <h1>Aegis Ashore Missile Defense Test Complex</h1>
...
<p>Alticor Inc pursued the Aegis Ashore project as a &#8220;Super Sub&#8221; to URS Group, Inc., and developed the entire project estimate along with the Technical Proposal and Proposal Schedule. The Aegis Ashore project had two separate sites; The main site is located at the Pacific Missile Range Facility (PMRF) in Kauai, HI and the second site is located in Moorsetown, NJ (MNJ).</p>
<p>&nbsp;</p>
<p>The work at Aegis Ashore Missile Defense Text Complex (AAMDTC), located at the Pacific Missile Range Facility (PMRF) on the northwestern coast of the island of Kauai, Hawaii, consists of the Deckhouse Facility and the Launcher Facility.</p>
<p>&nbsp;</p>
<p>The Second site located in Moorsetown, NJ consists of the same Deckhouse facility (Deckhouse Support Building and Reconstitutable Deckhouse) that is located at PMRF.</p>
<p>&nbsp;</p>
                	...
                	<div class="about-sidebar">
                    	<div class="widget">
                            ...
                            <ul>
                                    ...
                                    <span>Kauai, HI and Moorsetown, NJ</span>
                                </li>
    ...
    <div class="project-result-slider">
        ...
        <div class="flexslider carousel">
          ...
          <ul class="slides">
			...
			<li><img src="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web-1024x684.jpg')}}" alt=""></li>
			...
			<li><img src="{{asset('wp-content/uploads/2019/06/Aegis-Ashore-web2-1024x684.jpg')}}" alt=""></li>
