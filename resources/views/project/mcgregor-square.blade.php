...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:image" content="{{asset('wp-content/uploads/2021/11/McGregor-Aerial1.jpg')}}"  />
...
<style type="text/css">
 .page-banner{               
 filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2021/12/McGregor-Square-Hero-V3.png', sizingMethod='scale');
-ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2021/12/McGregor-Square-Hero-V3.png', sizingMethod='scale')"; 
 }
</style>        
<![endif]-->
