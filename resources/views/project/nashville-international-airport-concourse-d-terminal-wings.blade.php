...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:image" content="{{asset('wp-content/uploads/2021/09/BWI-article-photo3.jpg')}}"  />
...
<style type="text/css">
 .page-banner{               
 filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2021/08/BN-Concourse-D-HP_Large_Hero_Template.png', sizingMethod='scale');
-ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2021/08/BN-Concourse-D-HP_Large_Hero_Template.png', sizingMethod='scale')"; 
 }
</style>        
<![endif]-->
