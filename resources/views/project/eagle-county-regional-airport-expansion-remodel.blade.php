...
<meta name='robots' content='index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1' />
	...
	<meta property="og:image" content="{{asset('wp-content/uploads/2020/04/Eagle-Resize-05.png')}}" />
	...
	<meta name="twitter:image" content="{{asset('wp-content/uploads/2020/04/Eagle-Resize-05.png')}}" />
	<meta name="twitter:site" content="@HenselPhelps" />
	<meta name="twitter:label1" content="Est. reading time" />
	<meta name="twitter:data1" content="1 minute" />
	<script type="application/ld+json" class="yoast-schema-graph">{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}","url":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}","name":"Eagle County Regional Airport Expansion and Remodel - Alticor Inc","isPartOf":{"@id":"https://publicwebsite.azurewebsites.net/#website"},"primaryImageOfPage":{"@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}#primaryimage"},"image":{"@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}#primaryimage"},"thumbnailUrl":"{{asset('wp-content/uploads/2020/04/Option-2-HP_Large_Hero_Template.jpg')}}" ,"datePublished":"2020-04-08T16:28:45+00:00","dateModified":"2021-09-02T18:14:13+00:00","description":"The Eagle County Regional Airport Expansion and Remodel project is a design build expansion and remodel of the existing airline terminal.","breadcrumb":{"@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["{{route('projects.eagle-county-regional-airport-expansion-remodel')}}"]}]},{"@type":"ImageObject","inLanguage":"en-US","@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}#primaryimage","url":"{{asset('wp-content/uploads/2020/04/Option-2-HP_Large_Hero_Template.jpg')}}" ,"contentUrl":"{{asset('wp-content/uploads/2020/04/Option-2-HP_Large_Hero_Template.jpg')}}" ,"width":1440,"height":720},{"@type":"BreadcrumbList","@id":"{{route('projects.eagle-county-regional-airport-expansion-remodel')}}#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://publicwebsite.azurewebsites.net/"},{"@type":"ListItem","position":2,"name":"Eagle County Regional Airport Expansion and Remodel"}]},{"@type":"WebSite","@id":"https://publicwebsite.azurewebsites.net/#website","url":"https://publicwebsite.azurewebsites.net/","name":"Alticor Inc","description":"","potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://publicwebsite.azurewebsites.net/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"}]}</script>
...
<style type="text/css">
 .page-banner{               
 filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2020/04/Option-2-HP_Large_Hero_Template.jpg', sizingMethod='scale');
-ms-filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src="{{asset('wp-content/uploads/2020/04/Option-2-HP_Large_Hero_Template.jpg', sizingMethod='scale')"; 
 }
</style>        
<![endif]-->
