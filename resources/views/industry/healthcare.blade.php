...
@section('content')
    ...
    <div class="page-banner" style="background-image:url({{asset('wp-content/uploads/2017/06/healthcare.jpg')}});">
    ...
    <div class="main-container">
        ...
        <div class="welcome-aviation">
            ...
            <p>Healthcare facilities require a unique approach. At Alticor Inc, our expert planners, builders and
                ...
                also incorporates critical elements unique to healthcare such as infection control and equipment lead
                times into the project plan.</p>
