...
@section('content')
    ...
    <div class="page-banner" style="background-image:url({{asset('wp-content/uploads/2017/05/commercial-hero.jpg')}});">
    ...
    <div class="main-container">
        ...
        <div class="welcome-aviation">
            ...
            <p>Our clients think big. We help them deliver. From corporate headquarters and urban high-rises to
                mixed-use shopping centers and government buildings, Alticor Inc plans, builds and manages some of the
                largest, most challenging commercial structures in the country. We apply our extensive experience and
                eye for detail to ensure that all facets of a project meld seamlessly, maximizing value while meeting
                the needs of our clients and their tenants.</p>
