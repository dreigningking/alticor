...
@section('content')
    ...
    <div class="page-banner" style="background-image:url({{asset('wp-content/uploads/2017/05/advanced-technology-hero.jpg')}});">
    ...
    <div class="main-container">
        ...
        <div class="welcome-aviation">
            ...
            <p>The digital age requires an innovative approach to your facility. Alticor Inc is well-versed in planning,
                building and managing complex technology projects including data centers, command centers, 24/7 call
                centers, R&amp;D, and manufacturing facilities. We understand the importance of collaborative planning
                and analysis during the early stages of complex mission critical facilities. Our proven construction
                experience and technical expertise assures our clients that their facilities achieve the highest
                standards for reliability, scalability, energy efficiency, maintainability and security.</p>
