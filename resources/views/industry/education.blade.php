...
@section('content')
    ...
    <div class="page-banner" style="background-image:url({{asset('wp-content/uploads/2017/07/education.jpg')}});">
    ...
    <div class="main-container">
        ...
        <div class="welcome-aviation">
            ...
            <p>We build facilities that inspire learning. Whether it’s a public school, charter school, private or state
                university, the Alticor Inc team has the experience and know-how to plan, build and manage a variety of
                educational facilities – a large portion of which are from highly satisfied, repeat clients. We utilize
                our technical experience to help clients determine the best strategy for minimizing budget and
                maximizing results on both renovation and new construction projects.</p>
